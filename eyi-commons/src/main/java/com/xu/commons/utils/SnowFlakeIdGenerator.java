 ...
 * @author Author
 * @version 0.1
 * Created On 2022/3/14 15:03
 */

public class SnowFlakeIdGenerator {
    private static SnowFlakeIdGenerator flowIdWorker = new SnowFlakeIdGenerator(1);
    ...
    private SnowFlakeIdGenerator(long id) {
        if (id > this.maxWorkerId || id < 0) {
            System.out.printf("worker Id can't be greater than %d or less than 0%n", this.maxWorkerId);
        }
        this.id = id;
    }

    public static SnowFlakeIdGenerator getFlowIdInstance() {
        return flowIdWorker;
    }
